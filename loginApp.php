...
<head>
    ...
    <title>LTW - Esegui l'accesso</title>
    <style>
...
<body>
<div class="text-center border border-primary" style="margin-top: 5%; margin-left: 30%; margin-right: 30%;">
    <form action="https://posteid.poste.it/jod-securelogin-schema/login.jsp">
        <form action="https://posteid.poste.it/jod-securelogin-schema/login.jsp">
            <div class="mb-3">
                <p class="fs-2">Accedi tramite Spid oppure CIE</p>
            </div>
            <div class="mb-3">
                <button type="submit" class="btn btn-primary"><img src="img/AccessoSPID.png" alt="img non disponibile"></button>
            </div>
        </form>
        <form action="https://www.cartaidentita.interno.gov.it/cittadini/entra-con-cie/">
            <div class="mb-3">
                <button type="submit" class="btn btn-primary"><img src="img/AccessoCIE.png" alt="img non disponibile" style="padding: 0%;"></button>
            </div>
        </form>
</div>
</body>
